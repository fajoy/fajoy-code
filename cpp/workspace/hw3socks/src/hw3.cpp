...
void init_req() {
        ...
        sscanf(query, "h1=%[^&]&p1=%[^&]&f1=%[^&]&sh1=%[^&]&sp1=%[^&]&"
                ...
                "h4=%[^&]&p4=%[^&]&f4=%[^&]&sh1=%[^&]&sp1=%[^&]&"
                "h5=%[^&]&p5=%[^&]&f5=%[^&]&sh1=%[^&]&sp1=%[^&]",
                &req.h1[0], &req.p1[0], &req.f1[0],&req.sh1[0], &req.sp1[0],
                &req.h2[0], &req.p2[0], &req.f2[0],&req.sh2[0], &req.sp2[0],
                &req.h3[0], &req.p3[0], &req.f3[0],&req.sh3[0], &req.sp3[0],
                &req.h4[0], &req.p4[0], &req.f4[0],&req.sh4[0], &req.sp4[0],
                &req.h5[0], &req.p5[0], &req.f5[0],&req.sh5[0], &req.sp5[0]
          );
...
void connect_socks(int i) {
        try {
                ...
                struct hostent *server = (struct hostent *) gethostbyname(sc[i].socks);
                dest[i].sin_addr = *((struct in_addr *) server->h_addr);
                dest[i].sin_addr.s_addr = inet_addr(sc[i].host);
                //dest[i].sin_addr.s_addr =inet_addr(sc[i].host);
                dest[i].sin_port = htons(sc[i].sport);
...
void initSc() {
        try {
                sc[0].initobg(0);
                sc[0].parse(&req.h1[0], &req.p1[0], &req.f1[0],&req.sh1[0],&req.sp1[0]);
                sc[1].initobg(1);
                sc[1].parse(&req.h2[0], &req.p2[0], &req.f2[0],&req.sh2[0],&req.sp2[0]);
                sc[2].initobg(2);
                sc[2].parse(&req.h3[0], &req.p3[0], &req.f3[0],&req.sh3[0],&req.sp3[0]);
                sc[3].initobg(3);
                sc[3].parse(&req.h4[0], &req.p4[0], &req.f4[0],&req.sh4[0],&req.sp4[0]);
                sc[4].initobg(4);
                sc[4].parse(&req.h5[0], &req.p5[0], &req.f5[0],&req.sh5[0],&req.sp5[0]);
